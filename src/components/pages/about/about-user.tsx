...
export const AboutUser = () => {
  return <div className={'w-full flex justify-center pb-[40px] pt-[20px]'}>
    ...
    <div className={cn('w-[180px] h-[180px] rounded-[180px] mx-6 cursor-pointer hover:scale-110 hover:shadow-xl hover:rotate-360 transition',style.ani)}>
      <img className={'w-full h-full object-cover rounded-[180px]'} src={UserImg} alt="" />
    </div>
    <div className={'hidden md:flex flex-col justify-around py-[10px] text-[14px]'}>
      <div className={cn('mr-[16px]', styleClassName, style.ani)}>数码科技爱好者 🤖️</div>

  ...
  return (
    <OTPInput
      ...
      containerClassName={cn(
        "flex items-center gap-2 has-disabled:opacity-50 dark:bg-gray-800 dark:text-gray-300 rounded-lg",
        containerClassName
      )}
...
function InputOTPSeparator({ ...props }: React.ComponentProps<"div">) {
  return (
    <div data-slot="input-otp-separator" role="separator" {...props}>
      <MinusIcon className="text-gray-500 dark:text-gray-400" />
    </div>
  );
}
